...
export function initVentas() {
    ...
    async function mostrarDetallesVenta(e) {
        ...
        try {
            ...
            document.getElementById('detalle-cliente').textContent = `${venta.cliente.nombre} (${venta.cliente.email})`;
            document.getElementById('detalle-fecha').textContent = new Date(venta.fecha).toLocaleDateString();
            document.getElementById('detalle-total').textContent = venta.total.toFixed(2);
            ...
            detalles.forEach(detalle => {
                ...
                tr.innerHTML = `
                    ...
                    <td>$${detalle.libro.precio.toFixed(2)}</td>
